...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_linel100_delay50_test)
{
  ...
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 2>> filter(100);
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_line100_delay50_progressive_test)
{
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_line1000_delay50_progressive_test)
{
  ATK::SimpleSinusGeneratorFilter<double> generator;
  generator.set_output_sampling_rate(48000);
  generator.set_frequency(480);

  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 2>> filter(1000);
  filter.set_input_sampling_rate(48000);
  filter.set_input_port(0, &generator, 0);
  filter.set_delay(0, 50);
  filter.set_ingain(0, 1);
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_liner100_delay50_test)
{
  std::vector<double> data(PROCESSSIZE);
  for(gsl::index i = 0; i < PROCESSSIZE; ++i)
  {
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_liner100_delay50_progressive_test)
{
  ATK::SimpleSinusGeneratorFilter<double> generator;
  generator.set_output_sampling_rate(48000);
  generator.set_frequency(480);
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_liner1000_delay50_progressive_test)
{
  ATK::SimpleSinusGeneratorFilter<double> generator;
  generator.set_output_sampling_rate(48000);
  generator.set_frequency(480);
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_complex_test)
{
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_delay_test)
{
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_delay_range_test)
{
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 3>> filter(128);
  ASSERT_THROW(filter.set_delay(0, 0), ATK::RuntimeError);
}

TEST(HadamardFeedbackDelayNetworkFilter, sinus_delay_range2_test)
{
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 3>> filter(128);
  ASSERT_THROW(filter.set_delay(0, 128), ATK::RuntimeError);
}

TEST(HadamardFeedbackDelayNetworkFilter, sinus_ingain_test)
{
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 3>> filter(128);
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_outgain_test)
{
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 3>> filter(128);
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_feedback_test)
{
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 3>> filter(128);
...
TEST(HadamardFeedbackDelayNetworkFilter, sinus_feedback_range_test)
{
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 3>> filter(128);
  ASSERT_THROW(filter.set_feedback(0, 1), ATK::RuntimeError);
}

TEST(HadamardFeedbackDelayNetworkFilter, sinus_feedback_range2_test)
{
  ATK::FeedbackDelayNetworkFilter<ATK::HadamardMixture<double, 3>> filter(128);
  ASSERT_THROW(filter.set_feedback(0, -1), ATK::RuntimeError);
}
