...
TEST(TriodeFilter, Koren_0_const)
{
...
TEST(TriodeFilter, EnhancedKoren_sin1k)
{
  std::array<double, PROCESSSIZE> data;
  {
    std::ifstream input(ATK_SOURCE_TREE "/tests/data/input.dat", std::ios::binary);
...
TEST(TriodeFilter, Leach_0_const_sin1k)
{
  std::array<double, PROCESSSIZE> data;
  {
    std::ifstream input(ATK_SOURCE_TREE "/tests/data/input.dat", std::ios::binary);
...
TEST(TriodeFilter, MunroPiazza_sin1k)
{
  std::array<double, PROCESSSIZE> data;
  {
    std::ifstream input(ATK_SOURCE_TREE "/tests/data/input.dat", std::ios::binary);
...
TEST(TriodeFilter, Dempwolf_sin1k)
{
  std::array<double, PROCESSSIZE> data;
  {
    std::ifstream input(ATK_SOURCE_TREE "/tests/data/input.dat", std::ios::binary);
  ...
  auto filter = ATK::TriodeFilter<double, ATK::DempwolfTriodeFunction<double>>::build_standard_filter();
  filter.set_input_sampling_rate(48000 * 4);
  filter.set_input_port(0, &oversampling_filter, 0);
