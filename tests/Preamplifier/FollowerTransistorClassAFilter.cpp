...
TEST(FollowerTransistorClassAFilter, sin1k)
{
  ...
  {
    std::ifstream check(ATK_SOURCE_TREE "/tests/data/output4_ftca.dat", std::ios::binary);
  ...
  auto filter = ATK::FollowerTransistorClassAFilter<double>::build_standard_filter();
